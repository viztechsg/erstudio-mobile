...
import { signInvoice } from '../../services/invoice';

const SalesSignInvoice = ({ navigation, onOK }) => {
    ...
    const handleConfirm = () => {
        ...
        signInvoice(id,signature).then(Alert.alert("Invoice Signing","Invoice has been signed")).then(handleClear).then(navigation.navigate('SalesView', { item: item }));
    }
    ...
    return (
        <View style={{ flex: 1 }}>
            <View style={styles.preview}>
                ...
                <Text style={{ color: 'white', fontSize: 16 }}>Customer's Invoice Signature</Text>
            </View>
...
export default SalesSignInvoice;