...
const SalesSignVO = ({ navigation, onOK }) => {
    ...
    const handleConfirm = () => {
        ...
        signVO(id,signature).then(Alert.alert("Variation Order Signing","Variation Order has been signed")).then(handleClear).then(navigation.navigate('SalesView', { item: item }));
    }
    ...
    return (
        <View style={{ flex: 1 }}>
            <View style={styles.preview}>
                ...
                <Text style={{ color: 'white', fontSize: 16 }}>Variation Order Customer's Signature</Text>
            </View>
